    ...
    class MV_Slider_Settings{
     ...
     public function admin_init(){
        add_settings_section(
          ...
          add_settings_field(
            'mv_slider_bullets',
            esc_html__( 'Display Bullet', 'mv-slider' ),
      ...
      foreach( $input as $key => $value ){
        ...
        switch ($key){
          case 'mv_slider_title':
            if( empty( $value ) ){
              add_settings_error( 'mv_slider_options', 'mv_slider_message', esc_html__( 'The title field can not be empty', 'mv-slider' ), 'success' );
